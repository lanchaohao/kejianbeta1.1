	...
	<div class="centers_m">
		...
		<div class="centers_ml">
			...
			<div class="centers_listm">
				...
				<%--href="javascript:return false;" class="center_in_self"><font>订单投诉</font></a>--%>
				<%--</span>--%>
				<span class="gjszmdm"> <a href="Publish.sf" class="center_in_self"><font>我发布的课程</font></a>
					<a href="Subscribe.sf" class="center_in_self"><font>我订阅的课程</font></a> <a
		...
		<!--一条开始-->
		<div class="public_m1">
			<div class="public_m2">用户所有订阅视频</div>
			<!--提示信息-->
			<div class="tip_notem">
				<ul>
					<!-- <li>1.请牢记支付密码</li>
					...
					<div class="yd_box">
						<div class="movie_box">
							<ul class="wjdc_list">
									...
									<%--<c:choose>--%>
									<%--<c:when test="${ordertable.orderStat=='1'}">--%>

									<%--<a href='Cancellationoforder.sf?orderID=${ordertable.orderID}' onClick="return confirm('联系客服说明情况')" class='xy'>取消订单</a>--%>
									<%--</c:when>--%>
									<%--<c:when test="${ordertable.orderStat=='2'}">--%>
									<%--<a href='querendingdan.sf?orderID=${ordertable.orderID}'--%>
									...
									<%--</c:choose>--%>
									<%--<c:choose>--%>
									<%--<c:when test="${ordertable.orderStat=='3'}">--%>
									<%--<a href='#' onClick="return confirm('请打开QQ?')" class='bianji'>联系客服</a>--%>
									<%--</c:when>--%>
									<%--</c:choose>--%>
									<%--<c:choose>--%>
									<%--<c:when test="${ordertable.orderStat=='4'}">--%>
									<%--<a href='delordertable.sf?orderID=${ordertable.orderID}' onClick="return confirm('是否删除此订单?')"--%>
									<%--class='del'>删除</a>--%>
									...
									<%--</div>--%>
								<li><a
										href="video.sf?dizhi=${fuck.videoAddress}&shipingID=${video.videoID}">
									<img src="<%=request.getContextPath()%>${video.videoImage}"height="250" width="500"
										 alt="#">
								</a></li>
								<li>
									<div class="tm_btitlt">
										<i class="btwenzi">课程视频名称:&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												${video.videoName}</i>
									</div>
								</li>
