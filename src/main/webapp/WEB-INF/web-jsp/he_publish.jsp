...
<div class="centers_m">
    ...
    <div class="centers_ml">
        ...
        <%--<div class="center_header">--%>
            <%--<a href="User_full_information.sf">--%>
                <%--<img--%>
        ...
        <div class="centers_listm">
            ...
            <%--href="javascript:return false;" class="center_in_self"><font>订单投诉</font></a>--%>
            <%--</span>--%>
            <span class="gjszmdm"> <a href="he_publish.sf?username=${user.userName}" class="center_in_self"><font>我发布的课程</font></a>
                    ...
                    <div class="movie_box">
                        <ul class="wjdc_list">
                            ...
                            <li><a
                                ...
                                <img src="<%=request.getContextPath()%>${video.videoImage}"
                                     alt="#">
                            </a></li>
                            <li>
                                <div class="tm_btitlt">
