...
<style type="text/css">
			...
			<div class="page-width clearfix">
				<div class="header-top__nav">
					<ul>
						...
						<li class="item"><a href="Shopping.sf">课程购买</a>
						<li class="item"><a href="videoFileTop">教学投稿</a>
				...
				<div class="header-top__user">
					<div class="search bar1">
						<form action="searchByName.sf">
							<input type="text" placeholder="请输入您要搜索的内容..." name="key">
	...
	<div class="header-c">
		<div class="page-width">
			...
			<div class="header-title">我爱学习~</div>
		</div>
	</div>
	</header>
	...
	<div id="sideBar">
		<div class="sideBar-list">
			...
			<br> <a href="#">教学</a> <a href="#">直播</a> <a href="#">最新</a> <br>
			<a href="#"><i></i>排序</a>
		</div>
		<br>
