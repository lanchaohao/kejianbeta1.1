...
<%-- 				<!--一条开始-->
		...
		<div class="public_m1">
			...
			<div class="public_m4">
				...
				<p>
					<em>您当前的银行账号：</em>
					<%--<c:if test="${empty user.useryinghangka}">--%>
						<%--<i>您还未设置银行卡信息</i>--%>
					<%--</c:if>--%>
						<i>${user.useryinghangka}</i>
				</p>
				<p>
					<em>银行名称：</em>
					<select
				...
				<form action="Update_bank_card.sf" method="post">
				<p>
					<em>户主姓名：</em> <input type="text" name="name"
						style="height: 23px; border: 1px solid #eaeaea; width: 140px" onfocus=this.blur()
						value="${user.userMingzi}">
				</p>
				<p>
					<em>银行卡号：</em> <input type="text" name="card"
						style="height: 23px; border: 1px solid #eaeaea; width: 140px"
				    >
				</p>
				<p>
					<em>确认卡号：</em> <input type="text" name="cardagain"
						style="height: 23px; border: 1px solid #eaeaea; width: 140px">
				</p>
				<p>
					<em>开户银行银行地点：</em> <input type="text" name="address"
						style="height: 23px; border: 1px solid #eaeaea; width: 140px;"
						>
				</p>

				<p>
					<em>请输入手机验证码：</em> <input type="text" name="phonecheck"
						style="height: 23px; border: 1px solid #eaeaea; width: 140px">
					<a href="#" class="liji_fsm">发送</a> <i>注：若未绑定手机号码，请前往账户安全页面进行绑定</i>
				</p>
					<input type="submit" value="更改银行卡"/>
				<%--<a href="#" class="public_m3">更改银行卡</a>--%>
				</form>>
			</div>
		</div>
</body>
