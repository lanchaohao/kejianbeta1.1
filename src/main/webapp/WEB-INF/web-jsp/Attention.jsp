				...
				<div class="yd_box">
					<div class="movie_box">
						<ul class="wjdc_list">
								...
								<%--</div>--%>
							<li><a
									href="he_information.sf?username=${user.userName}">
								<img src="<%=request.getContextPath()%>${user.userHand}"height="100" width="200"
									 alt="#">
							</a></li>
							<li>
								<div class="tm_btitlt">
									<i class="btwenzi">用户名称:&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											${user.userName}</i>
								</div>
							</li>
