...
public class UserListServiceImpl implements UserListService {
	...
	public List<videoEntity> Pagevideolist(String State, int dangqianye,int meiyexianshiduoshaoge,int searchType,String key) {
		...
		List<videoEntity> list = userListDaoImpl.Pagevideolist(State, dangqianye,meiyexianshiduoshaoge,searchType,key);
		return list;
	}
	...
	public int videocounByname(String countvideo) {
		int num = userListDaoImpl.videocounByName(countvideo);
		return num;
	}
